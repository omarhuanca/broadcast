...
import io.umss.app.br.broadcast.dto.message.SubscriberDTOV;
...
public class SubscriberResource {
    ...
    public ResponseEntity<Object> findAllObjects(@Nullable Integer status, @Nullable String firstName,
            @Nullable String lastName, @Nullable String email, @Nullable String cellphone,
            @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize,
            @RequestParam(value = "page", defaultValue = "0") Integer page, HttpServletRequest request) {

        Integer totalRecords;
        List<Subscriber> objectList;
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);

        objectList = service.getAllObjects(Optional.ofNullable(status), Optional.ofNullable(firstName),
                Optional.ofNullable(lastName), Optional.ofNullable(email), Optional.ofNullable(cellphone), pageSize,
                page);
        totalRecords = service.getCountAllObjects(Optional.ofNullable(status), Optional.ofNullable(firstName),
                Optional.ofNullable(lastName), Optional.ofNullable(email), Optional.ofNullable(cellphone));
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Object> deleteObject(@Valid @RequestBody SubscriberDTOV objectDTOV,
            @PathVariable("id") Long id, HttpServletRequest request) {
