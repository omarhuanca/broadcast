...
public class SubscriptionResource {
    ...
    public ResponseEntity<Object> findAllObjects(@Nullable Integer status, @Nullable Long classChannelId,
            @Nullable Long subscriberId, @Nullable Long categoryId,
            @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize,
            @RequestParam(value = "page", defaultValue = "0") Integer page, HttpServletRequest request) {

        Integer totalRecords;
        List<Subscription> objectList;
        HttpHeaders responseHeaders = new HttpHeaders();
        requestLog(request);

        objectList = service.getAllObjects(Optional.ofNullable(status), Optional.ofNullable(classChannelId),
                Optional.ofNullable(subscriberId), Optional.ofNullable(categoryId), pageSize, page);
        totalRecords = service.getCountAllObjects(Optional.ofNullable(status), Optional.ofNullable(classChannelId),
                Optional.ofNullable(subscriberId), Optional.ofNullable(categoryId));
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Object> deleteObject(@Valid @RequestBody SubscriptionDTOV objectDTOV,
            @PathVariable("id") Long id, HttpServletRequest request) {
